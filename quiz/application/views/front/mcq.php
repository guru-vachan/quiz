...
<html>
    ...
    <body>
        ...
        <?php include_once 'header/header.php';?>
         <a href="<?php echo base_url(); ?>home/logout"><button style="">logout </button></a>
        <?php
        ...
        <section class="slice-lg has-bg-cover bg-size-cover" style="background-image: url(<?=base_url()?>uploads/login_image/<?=$login_image_data[0]['image']?>); background-position: bottom bottom;">
            ...
            <div class="container">
                <div class="row cols-xs-space align-items-center text-center text-md-left">
                    ...
                    <form id="mcq_form" class="form-default" role="form" action="<?=base_url()?>home/test" method="POST">        
                            <div class="form-body">
                                <div class="text-center px-2">
                                    <h4 class="heading heading-4 strong-400 mb-4 font_light"><?php echo translate('Question Paper')?></h4>
                                </div>
                        ...
                        foreach ($result->results as $key => $value) { 
                            $i++;
                            $answer_array[] = $value->correct_answer;
                        ?>
                            
                        <h5 style="color: green"><?php echo $value->question; ?></h5>   
                        <div class="col-md-04"> 

                           <input type="radio" name="<?php echo $i ?>" value="<?php echo $value->correct_answer ?>"><span style="color: white"><?php echo $value->correct_answer ?> </span> 
                           <input type="radio" name="<?php echo $i ?>" value="<?php echo $value->incorrect_answers[0] ?>">
                           <span style="color: white"><?php echo $value->incorrect_answers[0] ?>  </span>
                           <input type="radio" name="<?php echo $i ?>" value="<?php echo $value->incorrect_answers[1] ?>">
                           <span style="color: white"><?php echo $value->incorrect_answers[1] ?>  </span>
                           <input type="radio" name="<?php echo $i ?>" value="<?php echo $value->incorrect_answers[2] ?>">
                           <span style="color: white"><?php echo $value->incorrect_answers[2] ?> </span> 
                        </div>   
                        <?php    
                        } 
                        ...
                        {
                            echo '<input type="hidden" name="final[]" value="'. $value. '">';
                        }
                    }else{ ?>
                    ...
                    <?php }
                        ...
                        <div style="display: flex;">
                            <div>
                                <button class="btn btn-info text-white" name="submit" type="Submit"><b>submit</b></button>
