                        ...
                        <div class="form-card form-card--style-2 z-depth-3-top">
                            ...
                            <div class="form-body">
                                <div class="text-center px-2">
                                    <h4 class="heading heading-4 strong-400 mb-4 font_light"><?php echo translate('Score')?></h4>
                                </div>
                               <span id="otp_error" class="text-danger"></span>
                                    <div class="row">
                                        ...
                                        <h4 style="color: white"> Thanks for participate in this quiz! Your Score is <?php echo $data; ?> </h4>
                                        <h5 style="color: white">If you want to play again please click on this button <a href="<?php echo base_url(); ?>home/test"><button style="">Play</button></a></h5>
