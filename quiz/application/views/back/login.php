...
<head>
    ...
    <title>Admin || <?=$this->system_title?></title>
...
<!--     <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700' rel='stylesheet' type='text/css'> -->
    ...
    <script src="<?=base_url()?>template/back/js/demo/bg-images.js"></script>
...
<body>
    <?php
        ...
        ?>
            <div id="container" class="cls-container" style="background:url(<?=$admin_login_image_url?>);background-repeat: no-repeat;background-size: cover;background-position: center top;">
        <?php
        } else {
        ?>
		    ...
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
		            <div class="mar-ver pad-btm">
                        ...
                        ?>
                                <img src="<?=base_url()?>uploads/footer_logo/<?=$footer_logo[0]['image']?>" style="width:70% ">
                        <?php
                            }
                            else {
                        ?>
                                <img src="<?=base_url()?>uploads/footer_logo/default_image.png" style="width: 70% ">
                        <?php
                            }
                        ?>
		                <h1 class="h4" style="margin-top: 35px"><?=$this->system_name?></h1>
		        ...
		        <div class="pad-all">
		            <a href="<?=base_url()?>admin/forget_pass" class="btn-link mar-rgt"><?php echo translate('forgot_password?')?></a>
		        </div>
		    </div>
		</div>
        <?php if(demo()){ ?>
                   ...
                   <div class="panel-body">
                       <div class="mar-ver">
                           ...
                           <div>
                               ...
                               <button type="button" class="btn btn-dark btn-xs cpy_btn" style="width: 100px"><?=translate('copy')?></button>
                           </div>
                       </div>
                   </div>
               </div>
