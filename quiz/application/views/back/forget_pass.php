...
<body>
	<?php
        ...
        ?>
            <div id="container" class="cls-container" style="background:url(<?=$forget_pass_image_url?>);background-repeat: no-repeat;background-size: cover;background-position: center top;">
        <?php
        } else {
        ?>
		...
		<div class="cls-content">
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
		            ...
		            <form action="<?=base_url()?>admin/submit_forget_pass" method="POST">
		        ...
		        <div class="pad-all">
		            <a href="<?=base_url()?>admin/login" class="btn-link mar-rgt"><?php echo translate('log_in')?></a>
